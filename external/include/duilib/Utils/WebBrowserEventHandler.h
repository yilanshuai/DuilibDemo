...
namespace DuiLib
{
    class CWebBrowserEventHandler
    {
        public:
            ...
            virtual void ClosingWindow(VARIANT_BOOL IsChildWindow, VARIANT_BOOL& cancel) {};
            virtual void TitleChanged(IDispatch* pDisp, BSTR title) {};

            virtual void FileDownload(VARIANT_BOOL* pvbCancel) {};
