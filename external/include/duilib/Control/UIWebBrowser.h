...
namespace DuiLib
{
	...
	public:
		...
		void Navigate2WithPost(LPCTSTR lpszUrl, char* bytes);
		void Refresh();
	...
	protected:
		...
		void ClosingWindow(VARIANT_BOOL IsChildWindow, VARIANT_BOOL& cancel);
		void TitleChanged(IDispatch *pDisp, BSTR title);
    void FileDownload(VARIANT_BOOL* pvbCancel);
